...
function getCollectionProductsQuery(limit, productMetafieldIdentifiers, hasFilters, variantMetafieldIdentifiers, collectionMetafieldIdentifiers, includeProducts) {
  return `
...
async function getCollection(fetchShopify, config) {
  const {
    collectionHandle,
